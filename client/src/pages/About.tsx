      ...
      <div className="bg-white rounded-lg shadow-md p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800 mb-2">Comprehensive Curriculum</h3>
            <p className="text-gray-600">
              Well-structured courses covering both fundamentals and advanced topics.
            </p>
          </div>
